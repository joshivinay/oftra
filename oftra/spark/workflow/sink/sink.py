...
class Sink(Node):
  ...
  def fetch_df_to_write(self: T, context: ApplicationContext) -> DataFrame:
  ...
  def writer_with_format(self: T, context: ApplicationContext, df: DataFrame) -> Union[DataFrameWriter, DataStreamWriter]:
  ...
  def writer_with_partition(self: T, context, writer: Union[DataFrameWriter, DataStreamWriter]) -> Union[DataFrameWriter, DataStreamWriter]:
  ...
  def writer_with_options(self: T, context, writer: Union[DataFrameWriter, DataStreamWriter]) -> Union[DataFrameWriter, DataStreamWriter]:
  ...
  def writer_with_sort_by(self: T, context, writer: Union[DataFrameWriter, DataStreamWriter]) -> Union[DataFrameWriter, DataStreamWriter]:
    return writer
    
  def writer_with_bucket_by(self: T, context, writer: Union[DataFrameWriter, DataStreamWriter]) -> Union[DataFrameWriter, DataStreamWriter]:
    return writer
  
  def writer_with_mode(self: T, context, writer: Union[DataFrameWriter, DataStreamWriter]) -> Union[DataFrameWriter, DataStreamWriter]:
  ...
  def write_df(self: T, context: ApplicationContext, writer:Union[DataFrameWriter, DataStreamWriter]) -> Union[DataFrameWriter, DataStreamWriter]:
      if type(writer) == DataFrameWriter:
        self.write_batch(context, writer)
      else:
        self.write_stream(context, writer)

  def write_batch(self: T, context: ApplicationContext, writer: DataFrameWriter):
  ...
  def write_stream(self: T, context: ApplicationContext, writer: DataStreamWriter) -> StreamingQuery:
    path = self.properties.get('savePath')
  ...
  def create(node: Dict[str, Any]) -> 'Sink':
    from oftra.spark.workflow.workflow_factory import sink_factory
    return sink_factory(node)
